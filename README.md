...
The contact form is handled using Formspree.  
Submissions are sent to an external service for processing without requiring a custom backend.

---

## 🚀 Deployment

The project is deployed using Vercel with continuous deployment connected to a GitHub repository.
